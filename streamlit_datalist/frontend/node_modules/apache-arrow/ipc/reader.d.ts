...
import { MessageHeader } from 'apache-arrow/enum';
import { Footer } from 'apache-arrow/ipc/metadata/file';
import { Schema, Field } from '../schema';
import { Message } from './metadata/message';
import * as metadata from './metadata/message';
import { ArrayBufferViewInput } from 'apache-arrow/util/buffer';
import { ByteStream, AsyncByteStream } from 'apache-arrow/io/stream';
import { RandomAccessFile, AsyncRandomAccessFile } from 'apache-arrow/io/file';
import { RecordBatch } from 'apache-arrow/recordbatch';
import { FileHandle, ArrowJSONLike, ReadableInterop } from 'apache-arrow/io/interfaces';
import { MessageReader, AsyncMessageReader } from 'apache-arrow/ipc/message';
...
declare abstract class RecordBatchReaderImpl<T extends {
    ...
    protected _loadVectors(header: metadata.RecordBatch, body: any, types: (Field | DataType)[]): import("apache-arrow/data").Data<any>[];
}
/** @ignore */
