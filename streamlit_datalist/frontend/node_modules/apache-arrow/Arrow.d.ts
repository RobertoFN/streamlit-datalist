...
export declare const util: {
    ...
    toArrayBufferView<T extends import("apache-arrow/interfaces").TypedArray>(ArrayBufferViewCtor: import("apache-arrow/interfaces").TypedArrayConstructor<T>, input: util_buffer_.ArrayBufferViewInput): T;
    toArrayBufferView<T extends import("apache-arrow/interfaces").BigIntArray>(ArrayBufferViewCtor: import("apache-arrow/interfaces").BigIntArrayConstructor<T>, input: util_buffer_.ArrayBufferViewInput): T;
    toArrayBufferViewIterator<T extends import("apache-arrow/interfaces").TypedArray>(ArrayCtor: import("apache-arrow/interfaces").TypedArrayConstructor<T>, source: string | ArrayBuffer | SharedArrayBuffer | ArrayBufferView | ArrayLike<number> | Iterable<number> | flatbuffers.ByteBuffer | IteratorResult<string | ArrayBuffer | SharedArrayBuffer | ArrayBufferView | ArrayLike<number> | Iterable<number> | flatbuffers.ByteBuffer | null | undefined> | ReadableStreamReadResult<string | ArrayBuffer | SharedArrayBuffer | ArrayBufferView | ArrayLike<number> | Iterable<number> | flatbuffers.ByteBuffer | null | undefined> | Iterable<util_buffer_.ArrayBufferViewInput> | null | undefined): IterableIterator<T>;
    toArrayBufferViewAsyncIterator<T extends import("apache-arrow/interfaces").TypedArray>(ArrayCtor: import("apache-arrow/interfaces").TypedArrayConstructor<T>, source: string | ArrayBuffer | SharedArrayBuffer | ArrayBufferView | ArrayLike<number> | Iterable<number> | flatbuffers.ByteBuffer | IteratorResult<string | ArrayBuffer | SharedArrayBuffer | ArrayBufferView | ArrayLike<number> | Iterable<number> | flatbuffers.ByteBuffer | null | undefined> | ReadableStreamReadResult<string | ArrayBuffer | SharedArrayBuffer | ArrayBufferView | ArrayLike<number> | Iterable<number> | flatbuffers.ByteBuffer | null | undefined> | Iterable<util_buffer_.ArrayBufferViewInput> | PromiseLike<util_buffer_.ArrayBufferViewInput> | AsyncIterable<util_buffer_.ArrayBufferViewInput> | null | undefined): AsyncIterableIterator<T>;
