...
import { IntBuilder } from 'apache-arrow/builder/int';
import { Dictionary, DataType } from 'apache-arrow/type';
import { Builder, BuilderOptions } from 'apache-arrow/builder';
...
export declare class DictionaryBuilder<T extends Dictionary, TNull = any> extends Builder<T, TNull> {
    ...
    flush(): import("apache-arrow/data").Data<T>;
    finish(): this;
    clear(): this;
