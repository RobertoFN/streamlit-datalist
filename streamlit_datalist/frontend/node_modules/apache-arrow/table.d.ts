...
import { RecordBatch } from 'apache-arrow/recordbatch';
import { DataFrame } from 'apache-arrow/compute/dataframe';
import { RecordBatchReader } from 'apache-arrow/ipc/reader';
import { DataType, RowLike, Struct } from 'apache-arrow/type';
import { Clonable, Sliceable, Applicative } from './vector';
import { Vector, Chunked, VectorBuilderOptions, VectorBuilderOptionsAsync } from 'apache-arrow/vector/index';
...
export interface Table<T extends {
    ...
    scan(next: import('apache-arrow/compute/dataframe').NextFunc, bind?: import('apache-arrow/compute/dataframe').BindFunc): void;
    scanReverse(next: import('apache-arrow/compute/dataframe').NextFunc, bind?: import('apache-arrow/compute/dataframe').BindFunc): void;
    countBy(name: import('apache-arrow/compute/predicate').Col | string): import('apache-arrow/compute/dataframe').CountByResult;
    filter(predicate: import('apache-arrow/compute/predicate').Predicate): import('apache-arrow/compute/dataframe').FilteredDataFrame<T>;
}
export declare class Table<T extends {
    ...
    static from<T extends {
        [key: string]: DataType;
    } = any>(source: import('apache-arrow/ipc/reader').FromArg0): Table<T>;
    static from<T extends {
        [key: string]: DataType;
    } = any>(source: import('apache-arrow/ipc/reader').FromArg2): Table<T>;
    static from<T extends {
        [key: string]: DataType;
    } = any>(source: import('apache-arrow/ipc/reader').FromArg1): Promise<Table<T>>;
    static from<T extends {
        [key: string]: DataType;
    } = any>(source: import('apache-arrow/ipc/reader').FromArg3): Promise<Table<T>>;
    static from<T extends {
        [key: string]: DataType;
    } = any>(source: import('apache-arrow/ipc/reader').FromArg4): Promise<Table<T>>;
    static from<T extends {
        [key: string]: DataType;
    } = any>(source: import('apache-arrow/ipc/reader').FromArg5): Promise<Table<T>>;
    static from<T extends {
        [key: string]: DataType;
    ...
    static fromAsync<T extends {
        [key: string]: DataType;
    } = any>(source: import('apache-arrow/ipc/reader').FromArgs): Promise<Table<T>>;
    /** @nocollapse */
