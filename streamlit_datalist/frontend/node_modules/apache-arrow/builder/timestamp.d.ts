import { FixedWidthBuilder } from 'apache-arrow/builder';
import { Timestamp, TimestampSecond, TimestampMillisecond, TimestampMicrosecond, TimestampNanosecond } from 'apache-arrow/type';
/** @ignore */
export declare class TimestampBuilder<T extends Timestamp = Timestamp, TNull = any> extends FixedWidthBuilder<T, TNull> {
}
/** @ignore */
